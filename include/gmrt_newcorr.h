...
extern "C"
{
  ...
  /* corr.h : Changed on 5 Feb, 1997. Fundamental Requirement of structures declared here is that they should have same sizes and alignment on all machines. DOS is exempted.
  April 1999:  Extensively revised for new version, filename changed to newcorr.h  */
...
#define DAS_H_KEY_AJAX 2017
#define DAS_D_KEY_AJAX 2018
#define DAS_H_KEY_AJAX_INLINE 3017
#define DAS_D_KEY_AJAX_INLINE 3018
...
#define DAS_HDRSIZE 200000
  ...
  typedef struct
  {
    int s0, s1, card;                        /* card points to relevant delay/FFT card. The two relevant samplers are given by daspar.samp_num[s0] and daspar.samp_num[s1]*/
