...
/*******************************************************************
*CLASS:	Information
*Stores all the input parameters to ajax. At run-time there is one 
*instance of this class being shared by all other objects that does 
*various operations on the data. 

*Also has an member function that read from a ajax.in file and 
...
{	
	...
	char			isInline;				// inline mode of ajax - read and write to SHM
	char			doFRB;					// inline mode of ajax for FRB pipeline
