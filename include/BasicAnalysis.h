...
public:
	...
	struct timeval timestamp; // timestamp information for FRB inline mode
	...
	BasicAnalysis(float *_rawData, int polarIndex_, long int _blockLength, struct timeval timestamp);
	~BasicAnalysis();
